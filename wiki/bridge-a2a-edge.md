...
## Related
- [[bridge-edges|two edges]], [[bridge-aggregate-model|aggregate model]], [[bridge-artifacts|artifacts]], [[bridge-disposition|disposition]], [[bridge-long-running|long-running collection]], [[bridge-a2a-consumer|A2A consumer]] (the calling side)

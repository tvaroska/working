      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">Updater</span>
            </div>
            <p className="text-sm leading-6 text-gray-300">
              Transform information overload into actionable insights with AI-powered content summaries and audio briefings.
            </p>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <form className="mt-6 sm:flex sm:max-w-md xl:col-span-2 xl:mt-0">
              ...
              <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 transition-colors"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 Updater, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
